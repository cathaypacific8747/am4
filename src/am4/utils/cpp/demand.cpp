...
py::dict to_dict(const PaxDemand& pd) { return py::dict("y"_a = pd.y, "j"_a = pd.j, "f"_a = pd.f); }

py::dict to_dict(const CargoDemand& cd) { return py::dict("l"_a = cd.l, "h"_a = cd.h); }
