...
class AircraftRoute():
    ...
    @staticmethod
    def create(ap0: am4utils._core.airport.Airport, ap1: am4utils._core.airport.Airport, ac: am4utils._core.aircraft.Aircraft, options: AircraftRoute.Options = AircraftRoute.Options(), user: am4utils._core.game.User = am4utils._core.game.User()) -> AircraftRoute: ...
    @staticmethod
...
class Route():
    ...
    def valid(self) -> bool:
        ...
        """
    pass
def find_routes(ap0: am4utils._core.airport.Airport, ac: am4utils._core.aircraft.Aircraft, options: AircraftRoute.Options = AircraftRoute.Options(), user: am4utils._core.game.User = am4utils._core.game.User()) -> typing.List[Destination]:
    pass
